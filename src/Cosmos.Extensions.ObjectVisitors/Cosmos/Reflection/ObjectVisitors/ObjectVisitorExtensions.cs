...
public static class ObjectVisitorExtensions
{
    ...
    public static IObjectVisitor<T> ToVisitor<T>(this T instanceObj,
        ...
        where T : class
    {
        return Cosmos.Reflection.ObjectVisitors.ObjectVisitor.Create(instanceObj, kind, repeatable, strictMode);
    }
    ...
    public static IObjectVisitor ToVisitor(this Type type,
        ...
        bool strictMode = StMode.NORMALE)
    {
        return Cosmos.Reflection.ObjectVisitors.ObjectVisitor.Create(type, kind, repeatable, strictMode);
    }
    ...
    public static IObjectVisitor ToVisitor(this Type type, IDictionary<string, object> initialValues,
        ...
        bool strictMode = StMode.NORMALE)
    {
        return Cosmos.Reflection.ObjectVisitors.ObjectVisitor.Create(type, initialValues, kind, repeatable, strictMode);
    }
