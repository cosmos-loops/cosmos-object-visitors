...
internal class FluentSetterBuilder : IFluentSetter, IFluentValueSetter
{
    ...
    IObjectSetter IFluentSetter.NewInstance(bool strictMode)
    {
        ...
        return Cosmos.Reflection.ObjectVisitors.Internals.ObjectVisitorFactoryCore.CreateForFutureInstance(_type, clone.With(x => x.Repeatable = RpMode.NON_REPEATABLE));
    }
    ...
    IObjectSetter IFluentSetter.InitialValues(IDictionary<string, object> initialValues, bool strictMode)
    {
        ...
        return Cosmos.Reflection.ObjectVisitors.Internals.ObjectVisitorFactoryCore.CreateForFutureInstance(_type, clone.With(x => x.Repeatable = RpMode.NON_REPEATABLE), initialValues);
    }
...
internal class FluentSetterBuilder<T> : IFluentSetter<T>, IFluentValueSetter<T>
{
    ...
    IObjectSetter<T> IFluentSetter<T>.NewInstance(bool strictMode)
    {
        ...
        return Cosmos.Reflection.ObjectVisitors.Internals.ObjectVisitorFactoryCore.CreateForFutureInstance<T>(clone.With(x => x.Repeatable = RpMode.NON_REPEATABLE));
    }
