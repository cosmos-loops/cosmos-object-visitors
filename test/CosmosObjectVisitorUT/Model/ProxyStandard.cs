namespace CosmosObjectVisitorUT.Model
{
    ...
    {
        public virtual int MethodWidthReturnInt()
        {
            return default;
        }

        public virtual string MethodWidthReturnString()
        {
            return default;
        }
        ...
        public virtual string MethodWidthParamsString(string str)
        {
            return default;
        }

        public virtual string MethodWidthParams(int a, string str, out int b)
        {
            b = default;
            return default;
        }
    ...
    {
        public int MethodWidthReturnInt()
        {
            return default;
        }

        public string MethodWidthReturnString()
        {
            return default;
        }
        ...
        public string MethodWidthParamsString(string str)
        {
            return default;
        }

        public string MethodWidthParams(int a, string str, out int b)
        {
            b = default;
            return default;
        }
